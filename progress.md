...
Status: `STEP 1 · PLAN — static checks verified; later phases OPEN`
...
| 2 · Design | `step-2-design` | `docs/design.md`, `src/contract.ts`, `src/router.ts`, `test/router.test.ts` | `OPEN — next branch` |
